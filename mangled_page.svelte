...
<div class="space-y-6 pb-12">
  ...
  <section class="mt-8 pt-8 border-t border-slate-200 dark:border-slate-700/50 w-full overflow-hidden">
    ...
    <div class="mt-8 border-t border-slate-100 dark:border-slate-800 pt-10">
      <div class="flex items-center justify-center -mb-2 sm:-mb-6 md:-mb-10 relative z-20">
        <h3 class="text-sm font-bold text-slate-400 dark:text-slate-500 uppercase tracking-widest pointer-events-none">{$t('footer.momen_spesial') || 'Momen Spesial'}</h3>
