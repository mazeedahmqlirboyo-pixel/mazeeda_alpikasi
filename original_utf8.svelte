<script lang="ts">
  ...
  const zakatItems = [
    { label: "Zakat Penghasilan", value: "penghasilan", icon: "≡اْ╝" },
    { label: "Zakat Maal (Harta)", value: "maal", icon: "≡اْ░" },
    { label: "Zakat Fitrah", value: "fitrah", icon: "≡اî╛" },
    { label: "Zakat Tabungan", value: "tabungan", icon: "≡اخ" },
    { label: "Zakat Emas", value: "emas", icon: "≡ازآ" },
    { label: "Zakat Perak", value: "perak", icon: "≡احê" },
    { label: "Zakat Pertanian", value: "pertanian", icon: "≡اأ£" },
    { label: "Zakat Perdagangan", value: "perniagaan", icon: "≡اش" },
    { label: "Zakat Saham", value: "saham", icon: "≡اôê" },
    { label: "Zakat Reksadana", value: "reksadana", icon: "≡اôè" },
    { label: "Zakat Peternakan", value: "peternakan", icon: "≡ا" },
    { label: "Zakat Tambak", value: "tambak", icon: "≡اا" },
    { label: "Zakat Perusahaan", value: "perusahaan", icon: "≡ات" },
    { label: "Zakat Properti", value: "properti_sewa", icon: "≡اب" },
    { label: "Zakat Pertambangan", value: "pertambangan", icon: "ظؤي╕" },
  ];
  ...
  {#if calculatorType === "zakat"}
    ...
    <div class="relative space-y-1.5">
      ...
      <label class="text-[10px] font-black text-slate-400 uppercase tracking-widest leading-none flex items-center gap-1">
        ...
        <span class="text-slate-350 text-[8px] animate-pulse">ظû╝</span>
      </label>
      ...
      >
        <div class="flex items-center gap-2.5">
          <span class="text-base shrink-0">
            {zakatItems.find(item => item.value === activeTab)?.icon || '≡اـî'}
          </span>
          <span class="truncate">
      ...
      <Card class="p-5 space-y-4 shadow-soft-sm">
        ...
        <div class="space-y-1.5">
          ...
          {#if gajiBulanan > 0}
            ...
            >
              ≡اùثي╕ Terbilang: {terbilang(gajiBulanan)}
            </p>
          {/if}
        </div>
        ...
        <div class="space-y-1.5">
          ...
          {#if pendapatanLain > 0}
            <p
              ...
              class="text-[10px] text-emerald-600 font-extrabold mt-1 tracking-wide leading-none capitalize"
            >
              ≡اùثي╕ Terbilang: {terbilang(pendapatanLain)}
            </p>
          {/if}
        </div>
            ...
            <div in:slide={{ duration: 150 }} class="space-y-1.5 pl-7">
              ...
              {#if kebutuhanBulanan > 0}
                <p
                  ...
                  class="text-[10px] text-emerald-600 font-extrabold mt-1 tracking-wide leading-none capitalize"
                >
                  ≡اùثي╕ Terbilang: {terbilang(kebutuhanBulanan)}
                </p>
              {/if}
            </div>
          {/if}
        ...
        >
          {#if wajibZakatPenghasilan}
            ...
            {#if jumlahZakatPenghasilan > 0}
              <p
                class="text-[10px] text-emerald-600 font-extrabold mt-1 tracking-wide leading-none capitalize"
              >
                ≡اùثي╕ Terbilang: {terbilang(jumlahZakatPenghasilan)}
              </p>
            {/if}
            <p
          ...
          {:else}
            ...
            {#if sedekahRekomendasiPenghasilan > 0}
              ...
              >
                ≡اùثي╕ Terbilang: {terbilang(sedekahRekomendasiPenghasilan)}
              </p>
            {/if}
            <p
              class="text-[10px] text-slate-400 font-medium max-w-[280px] mx-auto leading-normal pt-1.5"
        ...
        <div class="space-y-1.5">
          ...
          {#if uangTunai > 0}
            <p
              ...
              class="text-[10px] text-emerald-600 font-extrabold mt-1 tracking-wide leading-none capitalize"
            >
              ≡اùثي╕ Terbilang: {terbilang(uangTunai)}
            </p>
          {/if}
        </div>
        ...
        <div class="space-y-1.5">
          ...
          {#if investasi > 0}
            <p
              ...
              class="text-[10px] text-emerald-600 font-extrabold mt-1 tracking-wide leading-none capitalize"
            >
              ≡اùثي╕ Terbilang: {terbilang(investasi)}
            </p>
          {/if}
        </div>
        ...
        <div class="space-y-1.5">
          ...
          {#if properti > 0}
            <p
              ...
              class="text-[10px] text-emerald-600 font-extrabold mt-1 tracking-wide leading-none capitalize"
            >
              ≡اùثي╕ Terbilang: {terbilang(properti)}
            </p>
          {/if}
        </div>
        ...
        <div class="space-y-1.5">
          ...
          {#if piutang > 0}
            <p
              ...
              class="text-[10px] text-emerald-600 font-extrabold mt-1 tracking-wide leading-none capitalize"
            >
              ≡اùثي╕ Terbilang: {terbilang(piutang)}
            </p>
          {/if}
        </div>
        ...
        <div class="pt-2 border-t border-slate-100 space-y-1.5">
          ...
          {#if hutang > 0}
            <p
              ...
              class="text-[10px] text-emerald-600 font-extrabold mt-1 tracking-wide leading-none capitalize"
            >
              ≡اùثي╕ Terbilang: {terbilang(hutang)}
            </p>
          {/if}
        </div>
      </Card>
          ...
          {#if wajibZakatMaal}
            ...
            {#if jumlahZakatMaal > 0}
              <p
                class="text-[10px] text-emerald-600 font-extrabold mt-1 tracking-wide leading-none capitalize"
              >
                ≡اùثي╕ Terbilang: {terbilang(jumlahZakatMaal)}
              </p>
            {/if}
            <p
              class="text-[10px] text-slate-400 font-medium max-w-[280px] mx-auto leading-normal pt-1.5"
          ...
          {:else}
            ...
            {#if sedekahRekomendasiMaal > 0}
              <p
                class="text-[10px] text-primary font-extrabold mt-1 tracking-wide leading-none capitalize"
              >
                ≡اùثي╕ Terbilang: {terbilang(sedekahRekomendasiMaal)}
              </p>
            {/if}
            <p
              class="text-[10px] text-slate-400 font-medium max-w-[280px] mx-auto leading-normal pt-1.5"
        ...
        <div class="space-y-1.5">
          ...
          {#if hargaBeras > 0}
            <p
              ...
              class="text-[10px] text-emerald-600 font-extrabold mt-1 tracking-wide leading-none capitalize"
            >
              ≡اùثي╕ Terbilang: {terbilang(hargaBeras)}
            </p>
          {/if}
        </div>
      </Card>
        ...
        >
          ...
          <div class="pt-2 border-t border-slate-200/50">
            ...
            <p
              class="text-[10px] text-emerald-600 font-extrabold mt-1 tracking-wide leading-none capitalize"
            >
              ≡اùثي╕ Terbilang: {terbilang(totalZakatUangFitrah)}
            </p>
          </div>
        </div>
      </Card>
        ...
        <div class="space-y-1.5">
          ...
          {#if saldoTabungan > 0}
            <p
              ...
              class="text-[10px] text-emerald-600 font-extrabold mt-1 tracking-wide leading-none capitalize"
            >
              ≡اùثي╕ Terbilang: {terbilang(saldoTabungan)}
            </p>
          {/if}
        </div>
      </Card>
        ...
        >
          {#if wajibZakatTabungan}
            ...
            <p
              class="text-[10px] text-emerald-600 font-extrabold mt-1 tracking-wide leading-none capitalize"
            >
              ≡اùثي╕ Terbilang: {terbilang(jumlahZakatTabungan)}
            </p>
          {:else}
            <p
              class="text-[10px] font-black text-slate-400 uppercase tracking-widest leading-none"
            ...
            {#if sedekahRekomendasiTabungan > 0}
              <p
                class="text-[10px] text-primary font-extrabold mt-1 tracking-wide leading-none capitalize"
              >
                ≡اùثي╕ Terbilang: {terbilang(sedekahRekomendasiTabungan)}
              </p>
            {/if}
            <p
        ...
        >
          {#if wajibZakatEmas}
            ...
            <p
              class="text-[10px] text-emerald-600 font-extrabold mt-1 tracking-wide leading-none capitalize"
            >
              ≡اùثي╕ Terbilang: {terbilang(jumlahZakatEmas)}
            </p>
          {:else}
            <p
              class="text-[10px] font-black text-slate-400 uppercase tracking-widest leading-none"
        ...
        <div class="space-y-1.5">
          ...
          {#if hargaPerak > 0}
            <p
              ...
              class="text-[10px] text-emerald-600 font-extrabold mt-1 tracking-wide leading-none capitalize"
            >
              ≡اùثي╕ Terbilang: {terbilang(hargaPerak)}
            </p>
          {/if}
        </div>
      </Card>
        ...
        >
          {#if wajibZakatPerak}
            ...
            <p
              class="text-[10px] text-emerald-600 font-extrabold mt-1 tracking-wide leading-none capitalize"
            >
              ≡اùثي╕ Terbilang: {terbilang(jumlahZakatPerak)}
            </p>
          {:else}
            <p
              class="text-[10px] font-black text-slate-400 uppercase tracking-widest leading-none"
    ...
    <div in:fade={{ duration: 150 }} class="space-y-5">
        ...
        <div class="space-y-1.5">
          ...
          {#if hargaPanen > 0}
            <p
              ...
              class="text-[10px] text-emerald-600 font-extrabold mt-1 tracking-wide leading-none capitalize"
            >
              ≡اùثي╕ Terbilang: {terbilang(hargaPanen)}
            </p>
          {/if}
        </div>
      ...
      >
        ...
        <div class="mt-4 pt-3 border-t border-slate-100 text-[11px] text-slate-500 space-y-1.5 bg-slate-50/50 p-3 rounded-xl text-left">
          <p class="font-bold text-slate-700 uppercase tracking-wider text-[9px] mb-1.5">≡ا¤ش Detail Perhitungan:</p>
          <p>ظت <strong>Total Panen:</strong> {hasilPanen || 0} kg (Nisab: 653 kg beras)</p>
          <p>ظت <strong>Metode Pengairan:</strong> {jenisPengairan === 'alami' ? 'Alami / Tadah Hujan (Tarif 10%)' : 'Buatan / Pompa Berbayar (Tarif 5%)'}</p>
          <p>ظت <strong>Status:</strong> {#if wajibZakatPertanian}<span class="text-emerald-600 font-bold">Wajib Zakat (Panen >= 653 kg)</span>{:else}<span class="text-slate-500 font-bold">Belum Wajib Zakat</span>{/if}</p>
          {#if wajibZakatPertanian}
            <p>ظت <strong>Kadar Zakat (kg):</strong> {hasilPanen || 0} kg &times; {jenisPengairan === 'alami' ? '10%' : '5%'} = <strong class="text-emerald-600">{jumlahZakatPertanianKg.toFixed(1)} kg</strong></p>
            {#if hargaPanen > 0}
              <p>ظت <strong>Jika Diuangkan:</strong> {jumlahZakatPertanianKg.toFixed(1)} kg &times; {formatRupiah(hargaPanen)} / kg = <strong class="text-emerald-600">{formatRupiah(jumlahZakatPertanianRupiah)}</strong></p>
            {/if}
          {:else}
            <p class="text-slate-400 italic">ظت Tidak ada kewajiban zakat hasil pertanian karena total hasil panen di bawah batas minimum (nisab).</p>
          {/if}
        </div>
          ...
          {#if wajibZakatPertanian}
            ...
            <div class="pt-2 border-t border-slate-200/50">
              ...
              <p
                class="text-[10px] text-emerald-600 font-extrabold mt-1 tracking-wide leading-none capitalize"
              >
                ≡اùثي╕ Terbilang: {terbilang(jumlahZakatPertanianRupiah)}
              </p>
            </div>
          {:else}
            <p
  ...
  {#if activeTab === "perniagaan"}
    <div in:fade={{ duration: 150 }} class="space-y-5">
        ...
        <div class="space-y-1.5">
          ...
          {#if modalUsaha > 0}
            <p
              ...
              class="text-[10px] text-emerald-600 font-extrabold mt-1 tracking-wide leading-none capitalize"
            >
              ≡اùثي╕ Terbilang: {terbilang(modalUsaha)}
            </p>
          {/if}
        </div>
        ...
        <div class="space-y-1.5">
          ...
          {#if keuntunganUsaha > 0}
            <p
              ...
              class="text-[10px] text-emerald-600 font-extrabold mt-1 tracking-wide leading-none capitalize"
            >
              ≡اùثي╕ Terbilang: {terbilang(keuntunganUsaha)}
            </p>
          {/if}
        </div>
        ...
        <div class="space-y-1.5">
          ...
          {#if piutangDagang > 0}
            <p
              ...
              class="text-[10px] text-emerald-600 font-extrabold mt-1 tracking-wide leading-none capitalize"
            >
              ≡اùثي╕ Terbilang: {terbilang(piutangDagang)}
            </p>
          {/if}
        </div>
        ...
        <div class="space-y-1.5">
          ...
          {#if hutangDagang > 0}
            <p
              ...
              class="text-[10px] text-emerald-600 font-extrabold mt-1 tracking-wide leading-none capitalize"
            >
              ≡اùثي╕ Terbilang: {terbilang(hutangDagang)}
            </p>
          {/if}
        </div>
      </Card>
      ...
      >
        ...
        <div class="mt-4 pt-3 border-t border-slate-100 text-[11px] text-slate-500 space-y-1.5 bg-slate-50/50 p-3 rounded-xl text-left">
          <p class="font-bold text-slate-700 uppercase tracking-wider text-[9px] mb-1.5">≡ا¤ش Detail Perhitungan:</p>
          <p>ظت <strong>Total Aset Usaha:</strong> Modal Usaha ({formatRupiah(modalUsaha || 0)}) + Keuntungan ({formatRupiah(keuntunganUsaha || 0)}) + Piutang ({formatRupiah(piutangDagang || 0)}) = {formatRupiah(totalAsetUsaha)}</p>
          <p>ظت <strong>Hutang Dagang/Usaha:</strong> - {formatRupiah(hutangDagang || 0)}</p>
          <p>ظت <strong>Harta Bersih Perdagangan:</strong> {formatRupiah(totalAsetUsaha)} - {formatRupiah(hutangDagang || 0)} = <strong>{formatRupiah(hartaPerniagaanKenaZakat)}</strong></p>
          <p>ظت <strong>Batas Nisab (85g Emas):</strong> {formatRupiah(nisabPerniagaan)}</p>
          <p>ظت <strong>Status:</strong> {#if wajibZakatPerniagaan}<span class="text-emerald-600 font-bold">Mencapai Nisab (Wajib Zakat 2.5%)</span>{:else}<span class="text-slate-500 font-bold">Belum Mencapai Nisab</span>{/if}</p>
          {#if wajibZakatPerniagaan}
            <p>ظت <strong>Kadar Zakat:</strong> {formatRupiah(hartaPerniagaanKenaZakat)} &times; 2.5% = <strong class="text-emerald-600">{formatRupiah(jumlahZakatPerniagaan)}</strong></p>
          {:else}
            <p>ظت <strong>Rekomendasi Sedekah:</strong> {formatRupiah(hartaPerniagaanKenaZakat)} &times; 2.5% = <strong class="text-primary">{formatRupiah(sedekahRekomendasiPerniagaan)}</strong></p>
          {/if}
        </div>
        ...
        >
          {#if wajibZakatPerniagaan}
            ...
            <p
              class="text-[10px] text-emerald-600 font-extrabold mt-1 tracking-wide leading-none capitalize"
            >
              ≡اùثي╕ Terbilang: {terbilang(jumlahZakatPerniagaan)}
            </p>
          {:else}
            <p
              class="text-[10px] font-black text-slate-400 uppercase tracking-widest leading-none"
            ...
            {#if sedekahRekomendasiPerniagaan > 0}
              <p
                class="text-[10px] text-primary font-extrabold mt-1 tracking-wide leading-none capitalize"
              >
                ≡اùثي╕ Terbilang: {terbilang(sedekahRekomendasiPerniagaan)}
              </p>
            {/if}
            <p
              class="text-[10px] text-slate-400 font-medium max-w-[280px] mx-auto leading-normal pt-1"
  ...
  {#if activeTab === "saham"}
    <div in:fade={{ duration: 150 }} class="space-y-5">
        ...
        <div class="space-y-1.5">
          ...
          {#if nilaiSaham > 0}
            <p
              ...
              class="text-[10px] text-emerald-600 font-extrabold mt-1 tracking-wide leading-none capitalize"
            >
              ≡اùثي╕ Terbilang: {terbilang(nilaiSaham)}
            </p>
          {/if}
        </div>
        ...
        <div class="space-y-1.5">
          ...
          {#if dividenSaham > 0}
            <p
              ...
              class="text-[10px] text-emerald-600 font-extrabold mt-1 tracking-wide leading-none capitalize"
            >
              ≡اùثي╕ Terbilang: {terbilang(dividenSaham)}
            </p>
          {/if}
        </div>
        ...
        <div class="space-y-1.5">
          ...
          {#if hutangSaham > 0}
            <p
              ...
              class="text-[10px] text-emerald-600 font-extrabold mt-1 tracking-wide leading-none capitalize"
            >
              ≡اùثي╕ Terbilang: {terbilang(hutangSaham)}
            </p>
          {/if}
        </div>
      </Card>
      ...
      >
        ...
        <div class="mt-4 pt-3 border-t border-slate-100 text-[11px] text-slate-500 space-y-1.5 bg-slate-50/50 p-3 rounded-xl text-left">
          <p class="font-bold text-slate-700 uppercase tracking-wider text-[9px] mb-1.5">≡ا¤ش Detail Perhitungan:</p>
          <p>ظت <strong>Nilai Saham:</strong> {formatRupiah(nilaiSaham || 0)}</p>
          <p>ظت <strong>Dividen Saham:</strong> + {formatRupiah(dividenSaham || 0)}</p>
          <p>ظت <strong>Hutang Saham:</strong> - {formatRupiah(hutangSaham || 0)}</p>
          <p>ظت <strong>Harta Saham Kena Zakat:</strong> ({formatRupiah(nilaiSaham || 0)} + {formatRupiah(dividenSaham || 0)}) - {formatRupiah(hutangSaham || 0)} = <strong>{formatRupiah(hartaSahamKenaZakat)}</strong></p>
          <p>ظت <strong>Batas Nisab (85g Emas):</strong> {formatRupiah(nisabSaham)}</p>
          <p>ظت <strong>Status:</strong> {#if wajibZakatSaham}<span class="text-emerald-600 font-bold">Mencapai Nisab (Wajib Zakat 2.5%)</span>{:else}<span class="text-slate-500 font-bold">Belum Mencapai Nisab</span>{/if}</p>
          {#if wajibZakatSaham}
            <p>ظت <strong>Kadar Zakat:</strong> {formatRupiah(hartaSahamKenaZakat)} &times; 2.5% = <strong class="text-emerald-600">{formatRupiah(jumlahZakatSaham)}</strong></p>
          {:else}
            <p>ظت <strong>Rekomendasi Sedekah:</strong> {formatRupiah(hartaSahamKenaZakat)} &times; 2.5% = <strong class="text-primary">{formatRupiah(sedekahRekomendasiSaham)}</strong></p>
          {/if}
        </div>
        ...
        >
          {#if wajibZakatSaham}
            ...
            <p
              class="text-[10px] text-emerald-600 font-extrabold mt-1 tracking-wide leading-none capitalize"
            >
              ≡اùثي╕ Terbilang: {terbilang(jumlahZakatSaham)}
            </p>
          {:else}
            <p
              class="text-[10px] font-black text-slate-400 uppercase tracking-widest leading-none"
            ...
            {#if sedekahRekomendasiSaham > 0}
              <p
                class="text-[10px] text-primary font-extrabold mt-1 tracking-wide leading-none capitalize"
              >
                ≡اùثي╕ Terbilang: {terbilang(sedekahRekomendasiSaham)}
              </p>
            {/if}
            <p
              class="text-[10px] text-slate-400 font-medium max-w-[280px] mx-auto leading-normal pt-1"
  ...
  {#if activeTab === "reksadana"}
    <div in:fade={{ duration: 150 }} class="space-y-5">
        ...
        <div class="space-y-1.5">
          ...
          {#if nilaiReksadana > 0}
            <p
              ...
              class="text-[10px] text-emerald-600 font-extrabold mt-1 tracking-wide leading-none capitalize"
            >
              ≡اùثي╕ Terbilang: {terbilang(nilaiReksadana)}
            </p>
          {/if}
        </div>
      </Card>
      ...
      >
        ...
        <div class="mt-4 pt-3 border-t border-slate-100 text-[11px] text-slate-500 space-y-1.5 bg-slate-50/50 p-3 rounded-xl text-left">
          <p class="font-bold text-slate-700 uppercase tracking-wider text-[9px] mb-1.5">≡ا¤ش Detail Perhitungan:</p>
          <p>ظت <strong>Nilai Reksadana:</strong> <strong>{formatRupiah(nilaiReksadana || 0)}</strong></p>
          <p>ظت <strong>Batas Nisab (85g Emas):</strong> {formatRupiah(nisabReksadana)}</p>
          <p>ظت <strong>Status:</strong> {#if wajibZakatReksadana}<span class="text-emerald-600 font-bold">Mencapai Nisab (Wajib Zakat 2.5%)</span>{:else}<span class="text-slate-500 font-bold">Belum Mencapai Nisab</span>{/if}</p>
          {#if wajibZakatReksadana}
            <p>ظت <strong>Kadar Zakat:</strong> {formatRupiah(nilaiReksadana || 0)} &times; 2.5% = <strong class="text-emerald-600">{formatRupiah(jumlahZakatReksadana)}</strong></p>
          {:else}
            <p>ظت <strong>Rekomendasi Sedekah:</strong> {formatRupiah(nilaiReksadana || 0)} &times; 2.5% = <strong class="text-primary">{formatRupiah(sedekahRekomendasiReksadana)}</strong></p>
          {/if}
        </div>
        ...
        >
          {#if wajibZakatReksadana}
            ...
            <p
              class="text-[10px] text-emerald-600 font-extrabold mt-1 tracking-wide leading-none capitalize"
            >
              ≡اùثي╕ Terbilang: {terbilang(jumlahZakatReksadana)}
            </p>
          {:else}
            <p
              class="text-[10px] font-black text-slate-400 uppercase tracking-widest leading-none"
            ...
            {#if sedekahRekomendasiReksadana > 0}
              <p
                class="text-[10px] text-primary font-extrabold mt-1 tracking-wide leading-none capitalize"
              >
                ≡اùثي╕ Terbilang: {terbilang(sedekahRekomendasiReksadana)}
              </p>
            {/if}
            <p
              class="text-[10px] text-slate-400 font-medium max-w-[280px] mx-auto leading-normal pt-1"
    ...
    <div in:fade={{ duration: 150 }} class="space-y-5">
        ...
        <div class="space-y-1.5">
          ...
          {#if hargaTernak > 0}
            <p
              ...
              class="text-[10px] text-emerald-600 font-extrabold mt-1 tracking-wide leading-none capitalize"
            >
              ≡اùثي╕ Terbilang: {terbilang(hargaTernak)}
            </p>
          {/if}
        </div>
      </Card>
      ...
      >
        ...
        <div class="mt-4 pt-3 border-t border-slate-100 text-[11px] text-slate-500 space-y-1.5 bg-slate-50/50 p-3 rounded-xl">
          <p class="font-bold text-slate-700 uppercase tracking-wider text-[9px] mb-1.5">≡ا¤ش Detail Perhitungan:</p>
          <p>ظت <strong>Jenis Ternak:</strong> <span class="capitalize">{jenisTernak}</span> (Nisab: {(jenisTernak === "kambing" || jenisTernak === "domba") ? "40" : "30"} ekor)</p>
          <p>ظت <strong>Jumlah Kepemilikan:</strong> {jumlahTernak || 0} ekor</p>
          <p>ظت <strong>Status Nisab:</strong> 
            {#if wajibZakatPeternakan}
          ...
          {#if wajibZakatPeternakan}
            <p>ظت <strong>Kewajiban Zakat:</strong> {zakatPeternakanResult.desc}</p>
            <p>ظت <strong>Rincian Jika Diuangkan:</strong> {zakatPeternakanResult.count} ekor zakat &times; {formatRupiah(hargaTernak)} / ekor = <strong class="text-emerald-600">{formatRupiah(jumlahZakatPeternakanRupiah)}</strong></p>
          {:else}
            <p class="text-slate-400 italic">ظت Tidak ada kewajiban zakat ternak karena jumlah di bawah batas minimum (nisab).</p>
          {/if}
        </div>
        ...
        >
          {#if wajibZakatPeternakan}
            ...
            <p
              class="text-[10px] text-emerald-600 font-extrabold mt-1 tracking-wide leading-none capitalize"
            >
              ≡اùثي╕ Terbilang: {terbilang(jumlahZakatPeternakanRupiah)}
            </p>
          {:else}
            <p
              class="text-[10px] font-black text-slate-400 uppercase tracking-widest leading-none"
  ...
  {#if activeTab === "tambak"}
    <div in:fade={{ duration: 150 }} class="space-y-5">
        ...
        <div class="space-y-1.5">
          ...
          {#if hasilPanenTambak > 0}
            <p
              ...
              class="text-[10px] text-emerald-600 font-extrabold mt-1 tracking-wide leading-none capitalize"
            >
              ≡اùثي╕ Terbilang: {terbilang(hasilPanenTambak)}
            </p>
          {/if}
        </div>
        ...
        <div class="space-y-1.5">
          ...
          {#if kasTambak > 0}
            <p
              ...
              class="text-[10px] text-emerald-600 font-extrabold mt-1 tracking-wide leading-none capitalize"
            >
              ≡اùثي╕ Terbilang: {terbilang(kasTambak)}
            </p>
          {/if}
        </div>
        ...
        <div class="space-y-1.5">
          ...
          {#if biayaTambak > 0}
            <p
              ...
              class="text-[10px] text-emerald-600 font-extrabold mt-1 tracking-wide leading-none capitalize"
            >
              ≡اùثي╕ Terbilang: {terbilang(biayaTambak)}
            </p>
          {/if}
        </div>
        ...
        <div class="space-y-1.5">
          ...
          {#if hutangTambak > 0}
            <p
              ...
              class="text-[10px] text-emerald-600 font-extrabold mt-1 tracking-wide leading-none capitalize"
            >
              ≡اùثي╕ Terbilang: {terbilang(hutangTambak)}
            </p>
          {/if}
        </div>
      </Card>
      ...
      >
        ...
        <div class="mt-4 pt-3 border-t border-slate-100 text-[11px] text-slate-500 space-y-1.5 bg-slate-50/50 p-3 rounded-xl text-left">
          <p class="font-bold text-slate-700 uppercase tracking-wider text-[9px] mb-1.5">≡ا¤ش Detail Perhitungan:</p>
          <p>ظت <strong>Total Aset Tambak:</strong> Hasil Panen ({formatRupiah(hasilPanenTambak || 0)}) + Uang Kas ({formatRupiah(kasTambak || 0)}) = {formatRupiah(totalAsetTambak)}</p>
          <p>ظت <strong>Pengurang:</strong> Biaya Operasional ({formatRupiah(biayaTambak || 0)}) + Hutang Jatuh Tempo ({formatRupiah(hutangTambak || 0)}) = {formatRupiah((biayaTambak || 0) + (hutangTambak || 0))}</p>
          <p>ظت <strong>Aset Bersih Tambak:</strong> {formatRupiah(totalAsetTambak)} - {formatRupiah((biayaTambak || 0) + (hutangTambak || 0))} = <strong>{formatRupiah(bersihTambak)}</strong></p>
          <p>ظت <strong>Batas Nisab (85g Emas):</strong> {formatRupiah(nisabTambak)}</p>
          <p>ظت <strong>Status:</strong> {#if wajibZakatTambak}<span class="text-emerald-600 font-bold">Mencapai Nisab (Wajib Zakat 2.5%)</span>{:else}<span class="text-slate-500 font-bold">Belum Mencapai Nisab</span>{/if}</p>
          {#if wajibZakatTambak}
            <p>ظت <strong>Kadar Zakat:</strong> {formatRupiah(bersihTambak)} &times; 2.5% = <strong class="text-emerald-600">{formatRupiah(jumlahZakatTambak)}</strong></p>
          {:else}
            <p>ظت <strong>Rekomendasi Sedekah:</strong> {formatRupiah(bersihTambak)} &times; 2.5% = <strong class="text-primary">{formatRupiah(sedekahRekomendasiTambak)}</strong></p>
          {/if}
        </div>
        ...
        >
          {#if wajibZakatTambak}
            ...
            <p
              class="text-[10px] text-emerald-600 font-extrabold mt-1 tracking-wide leading-none capitalize"
            >
              ≡اùثي╕ Terbilang: {terbilang(jumlahZakatTambak)}
            </p>
          {:else}
            <p
              class="text-[10px] font-black text-slate-400 uppercase tracking-widest leading-none"
            ...
            {#if sedekahRekomendasiTambak > 0}
              <p
                class="text-[10px] text-primary font-extrabold mt-1 tracking-wide leading-none capitalize"
              >
                ≡اùثي╕ Terbilang: {terbilang(sedekahRekomendasiTambak)}
              </p>
            {/if}
            <p
              class="text-[10px] text-slate-400 font-medium max-w-[280px] mx-auto leading-normal pt-1"
  ...
  {#if activeTab === "perusahaan"}
    <div in:fade={{ duration: 150 }} class="space-y-5">
        ...
        <div class="space-y-1.5">
          ...
          {#if asetLancarPerusahaan > 0}
            <p
              ...
              class="text-[10px] text-emerald-600 font-extrabold mt-1 tracking-wide leading-none capitalize"
            >
              ≡اùثي╕ Terbilang: {terbilang(asetLancarPerusahaan)}
            </p>
          {/if}
        </div>
        ...
        <div class="space-y-1.5">
          ...
          {#if hutangLancarPerusahaan > 0}
            <p
              ...
              class="text-[10px] text-emerald-600 font-extrabold mt-1 tracking-wide leading-none capitalize"
            >
              ≡اùثي╕ Terbilang: {terbilang(hutangLancarPerusahaan)}
            </p>
          {/if}
        </div>
      ...
      >
        ...
        <div class="mt-4 pt-3 border-t border-slate-100 text-[11px] text-slate-500 space-y-1.5 bg-slate-50/50 p-3 rounded-xl text-left">
          <p class="font-bold text-slate-700 uppercase tracking-wider text-[9px] mb-1.5">≡ا¤ش Detail Perhitungan:</p>
          <p>ظت <strong>Bersih Perusahaan (Total):</strong> Aset Lancar ({formatRupiah(asetLancarPerusahaan || 0)}) - Hutang Lancar ({formatRupiah(hutangLancarPerusahaan || 0)}) = {formatRupiah(bersihPerusahaan)}</p>
          <p>ظت <strong>Porsi Kepemilikan Anda ({persenKepemilikan}%):</strong> {formatRupiah(bersihPerusahaan)} &times; {persenKepemilikan}% = <strong>{formatRupiah(porsiBersihPerusahaan)}</strong></p>
          <p>ظت <strong>Batas Nisab (85g Emas):</strong> {formatRupiah(nisabPerusahaan)}</p>
          <p>ظت <strong>Status:</strong> {#if wajibZakatPerusahaan}<span class="text-emerald-600 font-bold">Mencapai Nisab (Wajib Zakat 2.5%)</span>{:else}<span class="text-slate-500 font-bold">Belum Mencapai Nisab</span>{/if}</p>
          {#if wajibZakatPerusahaan}
            <p>ظت <strong>Kadar Zakat:</strong> {formatRupiah(porsiBersihPerusahaan)} &times; 2.5% = <strong class="text-emerald-600">{formatRupiah(jumlahZakatPerusahaan)}</strong></p>
          {:else}
            <p>ظت <strong>Rekomendasi Sedekah:</strong> {formatRupiah(porsiBersihPerusahaan)} &times; 2.5% = <strong class="text-primary">{formatRupiah(sedekahRekomendasiPerusahaan)}</strong></p>
          {/if}
        </div>
        ...
        >
          {#if wajibZakatPerusahaan}
            ...
            <p
              class="text-[10px] text-emerald-600 font-extrabold mt-1 tracking-wide leading-none capitalize"
            >
              ≡اùثي╕ Terbilang: {terbilang(jumlahZakatPerusahaan)}
            </p>
          {:else}
            <p
              class="text-[10px] font-black text-slate-400 uppercase tracking-widest leading-none"
            ...
            {#if sedekahRekomendasiPerusahaan > 0}
              <p
                class="text-[10px] text-primary font-extrabold mt-1 tracking-wide leading-none capitalize"
              >
                ≡اùثي╕ Terbilang: {terbilang(sedekahRekomendasiPerusahaan)}
              </p>
            {/if}
            <p
              class="text-[10px] text-slate-400 font-medium max-w-[280px] mx-auto leading-normal pt-1"
  ...
  {#if activeTab === "properti_sewa"}
    <div in:fade={{ duration: 150 }} class="space-y-5">
        ...
        <div class="space-y-1.5">
          ...
          {#if pendapatanSewa > 0}
            <p
              ...
              class="text-[10px] text-emerald-600 font-extrabold mt-1 tracking-wide leading-none capitalize"
            >
              ≡اùثي╕ Terbilang: {terbilang(pendapatanSewa)}
            </p>
          {/if}
        </div>
        ...
        <div class="space-y-1.5">
          ...
          {#if biayaProperti > 0}
            <p
              ...
              class="text-[10px] text-emerald-600 font-extrabold mt-1 tracking-wide leading-none capitalize"
            >
              ≡اùثي╕ Terbilang: {terbilang(biayaProperti)}
            </p>
          {/if}
        </div>
      </Card>
      ...
      >
        ...
        <div class="mt-4 pt-3 border-t border-slate-100 text-[11px] text-slate-500 space-y-1.5 bg-slate-50/50 p-3 rounded-xl text-left">
          <p class="font-bold text-slate-700 uppercase tracking-wider text-[9px] mb-1.5">≡ا¤ش Detail Perhitungan:</p>
          <p>ظت <strong>Total Pendapatan Sewa:</strong> {formatRupiah(pendapatanSewa || 0)}</p>
          <p>ظت <strong>Biaya Perawatan Properti:</strong> - {formatRupiah(biayaProperti || 0)}</p>
          <p>ظت <strong>Hasil Sewa Bersih:</strong> {formatRupiah(pendapatanSewa || 0)} - {formatRupiah(biayaProperti || 0)} = <strong>{formatRupiah(bersihProperti)}</strong></p>
          <p>ظت <strong>Batas Nisab (85g Emas):</strong> {formatRupiah(nisabProperti)}</p>
          <p>ظت <strong>Status:</strong> {#if wajibZakatProperti}<span class="text-emerald-600 font-bold">Mencapai Nisab (Wajib Zakat 2.5%)</span>{:else}<span class="text-slate-500 font-bold">Belum Mencapai Nisab</span>{/if}</p>
          {#if wajibZakatProperti}
            <p>ظت <strong>Kadar Zakat:</strong> {formatRupiah(bersihProperti)} &times; 2.5% = <strong class="text-emerald-600">{formatRupiah(jumlahZakatProperti)}</strong></p>
          {:else}
            <p>ظت <strong>Rekomendasi Sedekah:</strong> {formatRupiah(bersihProperti)} &times; 2.5% = <strong class="text-primary">{formatRupiah(sedekahRekomendasiProperti)}</strong></p>
          {/if}
        </div>
        ...
        >
          {#if wajibZakatProperti}
            ...
            <p
              class="text-[10px] text-emerald-600 font-extrabold mt-1 tracking-wide leading-none capitalize"
            >
              ≡اùثي╕ Terbilang: {terbilang(jumlahZakatProperti)}
            </p>
          {:else}
            <p
              class="text-[10px] font-black text-slate-400 uppercase tracking-widest leading-none"
            ...
            {#if sedekahRekomendasiProperti > 0}
              <p
                class="text-[10px] text-primary font-extrabold mt-1 tracking-wide leading-none capitalize"
              >
                ≡اùثي╕ Terbilang: {terbilang(sedekahRekomendasiProperti)}
              </p>
            {/if}
            <p
              class="text-[10px] text-slate-400 font-medium max-w-[280px] mx-auto leading-normal pt-1"
  ...
  {#if activeTab === "pertambangan"}
    <div in:fade={{ duration: 150 }} class="space-y-5">
        ...
        <div class="space-y-1.5">
          ...
          {#if hasilTambang > 0}
            <p
              ...
              class="text-[10px] text-emerald-600 font-extrabold mt-1 tracking-wide leading-none capitalize"
            >
              ≡اùثي╕ Terbilang: {terbilang(hasilTambang)}
            </p>
          {/if}
        </div>
        ...
        <div class="space-y-1.5">
          ...
          {#if biayaTambang > 0}
            <p
              ...
              class="text-[10px] text-emerald-600 font-extrabold mt-1 tracking-wide leading-none capitalize"
            >
              ≡اùثي╕ Terbilang: {terbilang(biayaTambang)}
            </p>
          {/if}
        </div>
      </Card>
      ...
      >
        ...
        <div class="mt-4 pt-3 border-t border-slate-100 text-[11px] text-slate-500 space-y-1.5 bg-slate-50/50 p-3 rounded-xl text-left">
          <p class="font-bold text-slate-700 uppercase tracking-wider text-[9px] mb-1.5">≡ا¤ش Detail Perhitungan:</p>
          <p>ظت <strong>Total Nilai Hasil Tambang:</strong> {formatRupiah(hasilTambang || 0)}</p>
          <p>ظت <strong>Biaya Eksploitasi/Operasional:</strong> - {formatRupiah(biayaTambang || 0)}</p>
          <p>ظت <strong>Hasil Tambang Bersih:</strong> {formatRupiah(hasilTambang || 0)} - {formatRupiah(biayaTambang || 0)} = <strong>{formatRupiah(bersihTambang)}</strong></p>
          <p>ظت <strong>Batas Nisab (85g Emas):</strong> {formatRupiah(nisabPertambangan)}</p>
          <p>ظت <strong>Status:</strong> {#if wajibZakatPertambangan}<span class="text-emerald-600 font-bold">Mencapai Nisab (Wajib Zakat 2.5%)</span>{:else}<span class="text-slate-500 font-bold">Belum Mencapai Nisab</span>{/if}</p>
          {#if wajibZakatPertambangan}
            <p>ظت <strong>Kadar Zakat:</strong> {formatRupiah(bersihTambang)} &times; 2.5% = <strong class="text-emerald-600">{formatRupiah(jumlahZakatPertambangan)}</strong></p>
          {:else}
            <p>ظت <strong>Rekomendasi Sedekah:</strong> {formatRupiah(bersihTambang)} &times; 2.5% = <strong class="text-primary">{formatRupiah(sedekahRekomendasiPertambangan)}</strong></p>
          {/if}
        </div>
        ...
        >
          {#if wajibZakatPertambangan}
            ...
            <p
              class="text-[10px] text-emerald-600 font-extrabold mt-1 tracking-wide leading-none capitalize"
            >
              ≡اùثي╕ Terbilang: {terbilang(jumlahZakatPertambangan)}
            </p>
          {:else}
            <p
              class="text-[10px] font-black text-slate-400 uppercase tracking-widest leading-none"
            ...
            {#if sedekahRekomendasiPertambangan > 0}
              <p
                class="text-[10px] text-primary font-extrabold mt-1 tracking-wide leading-none capitalize"
              >
                ≡اùثي╕ Terbilang: {terbilang(sedekahRekomendasiPertambangan)}
              </p>
            {/if}
            <p
              class="text-[10px] text-slate-400 font-medium max-w-[280px] mx-auto leading-normal pt-1"
    ...
    <div in:fade={{ duration: 150 }} class="space-y-5">
      ...
      <Card class="p-5 space-y-4 shadow-soft-sm">
        ...
        <div class="space-y-1.5">
          ...
          {#if hartaKotor > 0}
            <p
              ...
              class="text-[10px] text-emerald-600 font-extrabold mt-1 tracking-wide leading-none capitalize"
            >
              ≡اùثي╕ Terbilang: {terbilang(hartaKotor)}
            </p>
          {/if}
        </div>
        ...
        {#if wasiatLimitWarning}
          ...
          >
            <span class="text-sm shrink-0">ظأبي╕</span>
      ...
      <Card class="p-5 space-y-4 shadow-soft-sm">
        ...
        >
          ...
          >
            {isAdvancedFaraidh ? 'Tutup Lanjutan' : 'ظ£ذ Mode Lanjutan'}
          </button>
        </h3>
